...
void TitleState::update()
{
	if (Game::Instance()->GetMouseBtn(0))
	{
		if ((498 <= Game::Instance()->getMousePosition().x) && (Game::Instance()->getMousePosition().x <= 712) && (410 <= Game::Instance()->getMousePosition().y) && (Game::Instance()->getMousePosition().y <= 470))
		{
			Game::Instance()->GetFSM().changeState(new GameState());
		}
		else if ((505 <= Game::Instance()->getMousePosition().x) && (Game::Instance()->getMousePosition().x <= 709) && (497 <= Game::Instance()->getMousePosition().y) && (Game::Instance()->getMousePosition().y <= 548))
		{
